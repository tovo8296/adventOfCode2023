...
fun main() {
    ...
    input.lines().forEach { line ->
        ...
        // Part 2
        val firstWordMatch = line.findAnyOf(words)
        val firstDigit = if (firstWordMatch != null) {
            if (firstWordMatch.first < firstNumberIndex) {
                words.indexOf(firstWordMatch.second) + 1
            } else {
        ...
        val lastWordMatch = line.findLastAnyOf(words)
        val lastDigit = if (lastWordMatch != null) {
            if (lastWordMatch.first > lastNumberIndex) {
                words.indexOf(lastWordMatch.second) + 1
            } else {
        ...
        val fullNumber = "$firstDigit$lastDigit".toInt()
        sum += fullNumber
    }
    print("Sum: $sum")
